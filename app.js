...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const zoneDiaries = {
        ...
        "KR-CN-02": {
            ...
            p1: "수도권과 남부를 잇는 천안 그레이시티에는 컨테이너 수용 단지가 드넓게 메우고 있습니다. 대기와 분진 수치가 49.2에 그치며 회복율 역시 51.5% 수준에 정체되어 있습니다.",
        ...
        "GL-SD-01": {
            ...
            p2: "바닷물이 거울처럼 투명해지고 해안 숲과 야생 캥거루, 펭귄 군락이 무서운 속도로 돔 외부로부터 안전 복귀하면서 남반구 최대의 악원이자 기후 정착지의 금자탑으로 도약했습니다."
        }
    };
    ...
    const zoneFutureTimelines = {
        ...
        "KR-CB-02": {
            ...
            futureP1: "청주 분지를 메운 미세 먼지와 독성을 광속 분해하는 바이오 정화림 중심가에 오창 과학 실향민 주거 복합타운의 웅장한 입주가 단행되었습니다.",
            futureP2: "미세 가루를 분해 살포하는 드론들이 정밀 환경 관리를 진행하며, 마당 한편에 탐스러운 배나무와 들풀이 자라나 대기 정화 속도를 아름답게 북돋우고 있습니다.",
            midTitle: "청주 도심 수돗물 및 지하 오염수 여과망 준공",
            midContent: "지하 깊숙이 스며들었던 폐수들을 역삼투압으로 흡착해 방출하는 오창 고도 여과 플랜트가 가동되어 지하 식수가 최고 등급으로 등극했습니다.",
            startContent: "청주 평야와 공업 전초 기지 주위의 기류 오염 발생원을 가시적으로 원격 추적하는 고해상도 대기 센서 네트워크가 장착되었습니다."
        },
        "KR-JB-02": {
            futureTitle: "전주 한옥 에코 빌리지 자정 복구 완료",
            futureP1: "한옥마을 주변 삼림 지대의 소나무 식생 밀도가 최고점에 도달하여, 오랫동안 이주를 기다려 온 전주 토박이 가구들이 안심하고 본가로 영구 복귀했습니다.",
            futureP2: "대나무 숲이 뿜어내는 깊고 청량한 산소 덕분에 기후 안정 점수가 10점 만점을 기록하며, 전주천 맑은 물가에서 이웃들이 모여 정겨운 잔치를 엽니다.",
            midTitle: "전주 완산 대숲 이산화탄소 영구 격리 구역 지정",
            midContent: "완산 숲의 바이오 탄소 격리 효율이 90% 선에 육박하여 주변 그레이시티에 맑은 신선 기류를 상시 수혈하는 천연 산소 허브로 지정되었습니다.",
            startContent: "전주천 상·하류의 수생 생태 피복 상태를 트래킹하고 수온 이변 데이터를 감시할 자동 음파 탐지 센서들을 전격 방류했습니다."
        },
        "KR-GN-03": {
            futureTitle: "창원 산소 보호 돔 주거 영구 해제 및 안착",
            futureP1: "창원 화학 산업 배후지의 대형 산소 제어 실드가 완전히 철거되고, 자연 대기와 융합된 친환경 주거 정착촌의 영구 분양이 단행되었습니다.",
            futureP2: "장벽 너머에 억류되었던 난민들이 마침내 자유를 얻어 공장 터에 복원된 침엽수 숲길을 걸으며 소박하고 행복한 삶을 일구기 시작하십니다.",
            midTitle: "창원 화학 토양 중화 나노 흡착층 포화 수렴",
            midContent: "지표면 수 미터 아래 찌들었던 오염물을 빨아들이는 스마트 나노 여과 포가 제 몫을 다해, 화학 오염도가 역사적인 청정 레벨로 진입했습니다.",
            startContent: "창원 대공업 밸리 전역의 공기 순환 방해요소를 제거하고 드론 조림의 씨앗 안착률을 트래킹할 특수 비행 통제소를 건립했습니다."
        },
        "GL-TY-01": {
            futureTitle: "도쿄 지요다 메가 기후 쉴드 타워 완공 및 정착",
            futureP1: "황실 정원을 중심으로 둘러싸인 거대 산소 쉴드가 대자연의 대기와 기류 순환 제어에 완벽히 동조하여, 황실 배후 공동 주거지가 완공 입주되었습니다.",
            futureP2: "인공 장막과 정교한 기포 보호막 내부의 맑은 햇살 아래서 옛 도쿄 시민들이 만나 정겨운 녹음 차를 마시며 평온하고 격조 있는 안식을 전개합니다.",
            midTitle: "도쿄만 연안 조류 독성 전수 분해 완료",
            midContent: "도쿄만 바닷물의 해조류 백화와 오염을 여과하는 플랑크톤 필터 장벽 설치가 성공하여, 투명한 도쿄 앞바다에 바다사자가 출현했습니다.",
            startContent: "도쿄 고층 도심 전역의 미세 유독 화학 성분 누출을 차단할 입체 자기 센서 돔 어레이들을 전격 빌딩 상부에 장착했습니다."
        },
        "GL-NY-01": {
            futureTitle: "뉴욕 센트럴파크 메가 식생 바이오 숲 자립",
            futureP1: "허드슨강 기후 역류 방벽 내부의 센트럴파크가 초대형 바이오 탄소 고정림으로 완전히 진화하여, 맨해튼에 입주한 귀향 가구들이 맑은 수목 생활을 누립니다.",
            futureP2: "고풍스러운 빌딩 숲 위로 쏟아지는 인공 대기와 청밀도 여과 기류가 뉴요커들의 삶의 질을 전 지구상 가장 고차원의 청정 세대로 복귀시켰습니다.",
            midTitle: "허드슨강 유수 유입 유해 매염 나노 여과막 준공",
            midContent: "침수되었던 뉴욕 지하철 터널과 도심 지하수의 산성 오염 물질을 정제해 흘려보내는 특수 정수 기어가 가동되어 완전 자정을 실현했습니다.",
            startContent: "맨해튼 연안의 해수면 폭등 조류 장벽 데이터와 인구 밀집 에코 보호구의 미세 기후 정밀 관제 센터를 전격 기동 완료했습니다."
        },
        "GL-LD-01": {
            futureTitle: "런던 템스 청정 수변 에코 타운 완공 입주",
            futureP1: "런던 빅벤과 국회의사당 뒤로 웅장하게 서 솟은 수직 탄소 청정 타워들이 대기를 100% 정화하여, 수변 친환경 명품 입주 가옥의 귀향식이 단행되었습니다.",
            futureP2: "맑게 흐르는 템스강 물결을 따라 하얀 돛배를 띄우며 옛 이웃들이 고향의 평온하고 격조 높은 삶을 완벽하게 즐기기 시작하십니다.",
            midTitle: "템스강 연안 지류 여과 화학 무해화 선언",
            midContent: "템스강으로 흘러들던 대공장 배후 오염 유입수가 나노 여과벽의 작용으로 식용 등급의 담수로 정제되어 흐르게 되었습니다.",
            startContent: "런던 대기 중의 기후 온난화 분진을 실시간 포집하는 흡입 흡착기 어레이와 인공 기상 제어 부이를 템스강에 앵커링했습니다."
        },
        "GL-PR-01": {
            futureTitle: "파리 샹젤리제 에코 참나무 벨트 개소",
            futureP1: "센강의 맑은 물길을 따라 파리 전역을 포근하게 가로지르는 덩굴 식물 정화 벨트와 샹젤리제 명품 친환경 주택의 정식 영구 귀향이 완료되었습니다.",
            futureP2: "에펠탑 기슭의 울창한 참나무 그늘 밑 노천카페에 모여 앉아, 맑고 가벼운 솔바람 공기를 마시며 옛 고향의 행복한 예술을 이야기하십니다.",
            midTitle: "센강 수중 오염도 역대급 최저 청정 수치 선언",
            midContent: "센강 강물에 고속 정화 여과 미생물을 방류하는 바이오 돔이 설치를 마쳐, 센강 물속 바닥 모래가 육안으로 들여다보일 만큼 투명해졌습니다.",
            startContent: "파리 외곽 그레이시티로부터 번져오는 혼탁한 유독 분진을 입체 감지하여 밀어낼 수직 방풍 기류 정화기를 도심에 설치했습니다."
        },
        "GL-BJ-01": {
            futureTitle: "베이징 자금성 친환경 대 정화 파크 개소",
            futureP1: "베이징 중심부의 황사와 탄소 가스가 인공 대전 집진 장치들의 작동으로 완전히 제거되어, 자금성 주변 친환경 안식 주거 주택이 전면 개방되었습니다.",
            futureP2: "뿌연 하늘 대신 눈부시게 푸르고 선명한 우주 하늘을 자금성 성곽 너머로 마주하며 귀향민들이 맑고 고상한 차문화를 안심하고 누리십니다.",
            midTitle: "베이징 차오양 배후 토양 바이오 정화층 완공",
            midContent: "토양 속 유독 성분과 화학 잔재들을 삼켜 정화하는 특수 유전자 변형 초목 이식 프로젝트가 성료되어, 대지 복원율이 80%를 넘어섰습니다.",
            startContent: "베이징 분지 지형의 미세 기후 정체를 미연에 격퇴할 대규모 대공 흡입 팬 필터들과 토질 분석 네트워크를 장착했습니다."
        },
        "GL-SD-01": {
            futureTitle: "시드니 항만 에코 돔 낙원 타운 개소",
            futureP1: "오페라하우스 해안선 장벽 내부의 항만 수질과 대기가 완벽한 자연 평형 지표를 복귀하여 남반구 최대 귀향 에코타운의 화려한 입주를 완성했습니다.",
            futureP2: "방벽 너머 태평양 기후 역류를 완벽히 통제한 정원 안에서, 야생 펭귄들과 귀향인들이 함께 맑고 투명한 바닷가 모래밭을 여유로이 거니십니다.",
            midTitle: "시드니 연안 산호초 백화 소멸 및 자연 피복",
    ...
    function initLeafletMaps() {
        ...
        // 지역별 식량 자급도·인구밀도에 따른 복구율 보정치. 전라도는 곡창지대라 식량 여유가 있어
        // 정화·재건 인프라 지원이 원활해 봉쇄 구역이 적고, 강원도는 산림이 많고 인구 밀도가 낮아
        // 자연 자정 속도가 빨라 안전 구역이 많다. 반대로 경상도·경기·서울/광역시는 인구밀집 대비
        // 식량 자급이 부족해 통제가 길어져 봉쇄 구역이 많다.
    ...
    // --- 7.5 GEMINI AI NATIONAL POLICY GENERATOR SYSTEM ---
    function initNationalPolicyGenerator() {
...
기후 대기 재난 지구로부터 수용 이주된 실향 1세대 원주민들의 자립 복원 가용 생계를 지원하기 위해 가구원 수에 비례하여 최대 분기별 180만원의 기후 생활 기본 소득을 보장한다.`
        ...
        btnPolicy.addEventListener("click", function() {
            ...
            // Inline keyframes inject if not exist
