...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const cityAnalysisData = {
        ...
        "KR-BS-01": { // 부산
            name: "부산 광역시",
            status: "예약 가능 (해운대 센텀 선별 예약)",
            statusClass: "reserve",
            summary: "부산 해운대 센텀 메가돔 구역의 해양 염무 정화벽이 마감 단계에 접어들어, 1차 주거 희망자 예약 접수가 가동 중입니다. 다만 영도 및 저지대 침수 구역과 낙동강 수계 인접 지역은 심각한 오염으로 여전히 전면 봉쇄 상태입니다.",
            metrics: {
                air: { val: "72/100", pct: 72, label: "센텀 해양 정화 완료", desc: "정밀 염무 스크러버 및 방벽 가동" },
                soil: { val: "24.5 ppm", pct: 68, label: "저지대 토양 복구 진행 중", desc: "센텀 일대 토양 중금속 독성 세척 마감" },
                veg: { val: "0.58 NDVI", pct: 58, label: "복구형 해안 조림지 구축", desc: "해바라기 및 흡착 식물 기반 정화 유도" }
            },
            reasons: [
                "<strong>해운대 센텀 메가돔 선별 귀향 예약:</strong> 완벽한 방호 기밀 돔과 염무 필터가 가동되는 해운대 센텀 특별 주거 지구에 한정해 일반 귀향 희망자의 1단계 선별 예약(예약 가능)을 접수받고 있습니다.",
                "<strong>낙동강 수계 및 구도심 봉쇄 유지:</strong> 만덕, 사하구 일대 중금속 오염과 낙동강 하류 오염 지하수는 정화 기준치에 도달하지 못해, 이외 광역 부산 영토의 일반인 진입은 엄격히 차단(봉쇄) 중입니다.",
                "<strong>해안 염수 유입 제어 통제:</strong> 메가돔 방벽 내부 수용 시설에 한하여 담수 자립 루프가 완성되어 일정한 생태 거주 적합 판정을 유지하고 있습니다."
            ]
        },
        "KR-DG-01": { // 대구
            name: "대구 광역시",
            status: "예약 가능 (수성 알파시티 선별 예약)",
            statusClass: "reserve",
            summary: "대구 수성구 알파시티 신생태 조림 및 통풍로 거점 구역에 한하여 대기 자정력이 확보되어 제한적 예약 접수가 승인되었습니다. 다만 서구 및 옛 가동 공단 배후지는 여전히 극심한 대기 정체로 전면 봉쇄 중입니다.",
            metrics: {
                air: { val: "68/100", pct: 68, label: "수성 알파 대류 정화망", desc: "고출력 이온 대기 통풍 서큘레이터 가동" },
                soil: { val: "18.2 ppm", pct: 70, label: "알파단지 중금속 중화 마감", desc: "지하수 역삼투압 미생물 자정 완료" },
                veg: { val: "0.62 NDVI", pct: 62, label: "인공 대류형 바람길 숲 조성", desc: "사막화 방지 유전자 저항 식생림 조림" }
            },
            reasons: [
                "<strong>수성 알파시티 예약 주거 구역 개방:</strong> 사막화 및 분지열 완화를 위한 풍동형 바람길 조림이 완료된 수성 알파 특구에 한하여 주거 적합 예비 판정을 받아 선별 예약(예약 가능)이 개시되었습니다.",
                "<strong>서구 염색공단 유공지 전면 봉쇄:</strong> 유독성 크롬 및 카드뮴 성분이 기준치의 3배 이상 검출되는 옛 서구 및 북구 오염 부지는 일반 시민 진입이 여전히 불가한 전면 차단 상태입니다.",
                "<strong>인공 지표 가습 순환 제어:</strong> 열섬 가스 배출용 대형 분사 타워 설치 범위 내에서만 호흡기 가이드라인 안전성이 특별 보장됩니다."
            ]
        },
        "KR-IC-01": { // 인천
            name: "인천 광역시",
