...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const cityAnalysisData = {
        ...
        "KR-BS-01": { // 부산
            ...
            status: "봉쇄 (진입 차단)",
            statusClass: "blocked",
            summary: "부산 해운대 센텀 메가돔 구역의 해양 염무 및 영도·낙동강 수계의 심각한 오염으로 인해 광역 전 국토가 일반인 진입 전면 차단 상태로 봉쇄되어 있습니다. 정화벽 보강 공사가 지속 진행 중입니다.",
            metrics: {
                air: { val: "72/100", pct: 72, label: "센텀 해양 정화 대기", desc: "정밀 염무 스크러버 가동 및 장비 부하 대응" },
                soil: { val: "24.5 ppm", pct: 68, label: "저지대 토양 복구 진행 중", desc: "센텀 일대 토양 중금속 독성 세척 마감 대기" },
                veg: { val: "0.58 NDVI", pct: 58, label: "복구형 해안 조림지 구축", desc: "해바라기 및 흡착 식물 기반 정화 유도" }
            },
            reasons: [
                "<strong>낙동강 수계 및 구도심 차단 유지:</strong> 만덕, 사하구 일대 중금속 오염과 낙동강 하류 오염 지하수가 정화 기준치에 대폭 미달하여 전면 봉쇄되었습니다.",
                "<strong>해안 염수 유입 제어 통제 불안정:</strong> 메가돔 담수 자립 루프 내부에서 일시적인 해수 역류 및 정화 장치 부하가 발생하여 진입 불허 판정을 유지하고 있습니다.",
                "<strong>임시 차단 격벽 보강 작업:</strong> 미정화 해풍 가스 유출 가능성에 대비하기 위해 외곽 방어선에 추가 장벽을 고정 조립하는 긴급 보수 과정에 돌입했습니다."
            ]
        },
        "KR-DG-01": { // 대구
            name: "대구 광역시",
            status: "봉쇄 (진입 차단)",
            statusClass: "blocked",
            summary: "대구 수성구 알파시티와 옛 염색공단 배후지의 극심한 대기 정체 및 기온 역전으로 인한 분지 가스 축적으로 인해 전 구역 일반 시민 진입이 엄격히 차단(봉쇄)된 상태입니다.",
            metrics: {
                air: { val: "68/100", pct: 68, label: "수성 알파 대류 정화망", desc: "고출력 이온 대기 통풍 서큘레이터 가동 및 풍량 감쇄 대응" },
                soil: { val: "18.2 ppm", pct: 70, label: "알파단지 중금속 중화 진행", desc: "지하수 역삼투압 미생물 자정 단계적 적용" },
                veg: { val: "0.62 NDVI", pct: 62, label: "인공 대류형 바람길 숲 조성", desc: "사막화 방지 유전자 저항 식생림 조림 및 관리" }
            },
            reasons: [
                "<strong>서구 염색공단 유공지 전면 봉쇄:</strong> 유독성 크롬 및 카드뮴 성분이 기준치를 대폭 초과 검출되어 대구 전역의 토양 및 생태계 진입 차단을 견인하고 있습니다.",
                "<strong>분지 대기 정체 및 열섬 가스 축적:</strong> 고출력 이온 대기 통풍 서큘레이터 가동에도 불구하고, 영남 내륙의 고온 다습 기류가 오염 먼지를 가두는 전형적인 대기 역전으로 위험군에 등재되었습니다.",
                "<strong>식생 조림 보호선 통제:</strong> 사막화 방지 유전자 저항 식생림 보호를 위한 토양 주입제 배포 작업 기간으로, 일반 시민의 발길을 안전하게 통제 및 규제하고 있습니다."
            ]
        },
        "KR-IC-01": { // 인천
            name: "인천 광역시",
        ...
        "KR-GJ-01": { // 광주
            name: "광주 광역시",
            status: "봉쇄 (진입 차단 - AI 첨단단지 제외)",
            statusClass: "blocked",
            summary: "광주광역시 전역은 주변 공업 농업 오염 지대의 영향으로 봉쇄 등급이 유지되고 있습니다. 다만 예외적으로 호남 최대 스마트 가로수 그리드가 가동되는 **AI 첨단단지** 구역만 국소 안전성이 충족되어 선별 복귀가 진행 중입니다.",
            metrics: {
                air: { val: "62/100", pct: 62, label: "오염 가스 유입 지속", desc: "첨단단지 내부 기밀 환기망 가동" },
                soil: { val: "38.5 ppm", pct: 54, label: "외각 화학 토양 유실 심각", desc: "첨단단지 내 바이오 미생물 정화 완수" },
                veg: { val: "0.45 NDVI", pct: 45, label: "외각 대다수 조림지 쇠퇴", desc: "AI 가로수 타워 반경 내만 조밀 식생" }
            },
            reasons: [
                "<strong>AI 첨단 특구 이외 전역 봉쇄:</strong> 실시간 기량 통제망 및 정화 에코 돔 내부인 **첨단지구 1등급 주거 구역**을 벗어난 광주 광역 영토는 중금속과 황화 가스로 가득 차 엄격한 진입 제한(봉쇄) 중입니다.",
                "<strong>스마트 그리드 차단막 유효:</strong> 청정 상수도 배관과 미세 중금속 정화 타워가 실시간 관제되는 첨단 지구 내부 한정으로만 호흡 안정도가 95% 이상 특별 확보되었습니다.",
                "<strong>선별 난민 귀향 등록 수용:</strong> 첨단 특구의 수용 용량 한계로 인해, 시 전반의 봉쇄는 유지하되 사전 허가된 1급 정착민 대상의 제한적 국소 주거만 가동되고 있습니다."
            ]
        },
        "KR-DJ-01": { // 대전
            name: "대전 광역시",
            status: "봉쇄 (진입 차단 - 연구단지 제외)",
            statusClass: "blocked",
            summary: "대전광역시 전반은 옛 화학 오염 분진 체류량이 기준치를 크게 웃돌아 전면 봉쇄 상태입니다. 다만 원천 복원 기술 특허 돔과 캐노피 필터가 완비된 **연구단지 특별 수용동** 구역만 특별 예외가 적용됩니다.",
            metrics: {
                air: { val: "58/100", pct: 58, label: "유성구 외각 스모그 정체", desc: "연구단지 밀폐형 특허 캐노피 작동" },
                soil: { val: "28.0 ppm", pct: 52, label: "지하수 산성화 극심", desc: "나노 정화 파우더 가용 특구만 1.0ppm 미만" },
                veg: { val: "0.38 NDVI", pct: 38, label: "지표 지수 전반적 고사", desc: "돔 내부 변형 나무 식생 그리드 보호 구동" }
            },
            reasons: [
                "<strong>원천 정밀 캐노피 반경만 안전 확보:</strong> 대공 가스와 산성 황사를 97% 이상 차단해 주는 **대덕연구단지 기술 시험용 캐노피** 구역 내부 한정으로만 주거 안정성이 예외적으로 허가되었습니다.",
                "<strong>대다수 구도심 전면 진입 차단:</strong> 대덕 캐노피 영향권을 벗어난 서구 및 구도심 전역은 지하 오염수 누출과 산성 대기 정체 현상으로 호흡기에 매우 치명적이며, 전면 봉쇄가 유지됩니다.",
                "<strong>특수 귀향 시험제 운영:</strong> 시 전역의 차단 명령 하에서 연구원 및 기술 정착민에 준하는 선별 난민층에 대해서만 연구단지 기밀 보장동으로 제한적 복귀를 선별 실행하고 있습니다."
            ]
        },
        "KR-US-01": { // 울산
            name: "울산 광역시",
    ...
    window.updateCityAnalysis = function(zoneId) {
        ...
        // Fall back to Seoul (KR-SL-01) if the currently selected zone is unsupported,
        // so the City Analysis tab always remains active and visually stunning!
        let activeZoneId = zoneId;
        if (cityAnalysisData[zoneId] == null) {
            activeZoneId = "KR-SL-01";
        }
        ...
        predPanel.innerHTML = `
            <!-- Core 7 Settlement Cities Selector -->
            <div class="dignity-card" style="background: var(--color-sidebar-bg); border: 1px solid var(--color-sidebar-border); border-radius: 16px; padding: 20px; margin-bottom: 24px;">
                <h4 style="font-family: 'Outfit', sans-serif; font-size: 13px; color: var(--color-text-main); opacity: 0.7; text-transform: uppercase; margin: 0 0 12px 0; font-weight: 700; letter-spacing: 0.5px; display: flex; align-items: center; gap: 8px;">
                    <i data-lucide="map-pin" style="color: var(--color-primary-dark); width: 16px; height: 16px;"></i> 핵심 정착 도시 빠른 분석 선택
                </h4>
                <div class="city-selector-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(130px, 1fr)); gap: 10px; width: 100%;">
                    ${citySelectorHtml}
                </div>
            </div>
    ...
    window.selectCityAnalysis = function(zoneId) {
        // Synchronize: updating selection switches map focus, timeline, and report simultaneously!
    ...
    function getTimelineCardsData(zoneId, zoneName) {
        ...
        const cityData = {
            "KR-SL-01": {
                cards: [
                    {
                        year: 2090, date: "2090년 04월 12일", badge: "PREDICTED 2090", type: "future", dir: "row",
                    ...
                    {
                        year: 2085, date: "2085년 06월 15일", badge: "PREDICTED 2085", type: "future", dir: "reverse",
                    ...
                    {
                        year: 2080, date: "2080년 10월 05일", badge: "PREDICTED 2080", type: "mid", dir: "row",
                    ...
                    {
                        year: 2070, date: "2070년 03월 20일", badge: "CURRENT 2070", type: "current",
                    ...
                    {
                        year: 2060, date: "2060년 06월 15일", badge: "COMPLETED 2060", type: "past",
                    ...
                    {
                        year: 2050, date: "2050년 08월 30일", badge: "BUDGET PASSED 2050", type: "past",
    ...
    function getUnsupportedCardsData(cityName) {
        const cards = [];
        const years = [2090, 2085, 2080, 2070, 2060, 2050];
    ...
    function generateDesktopCardHTML(card) {
        if (card.type === "current") {
            return `
                <div class="timeline-card-wrapper start" id="desktop-timeline-card-2070">
    ...
    function generateMobileCardHTML(card) {
        if (card.type === "current") {
            return `
                <div class="mobile-timeline-node" id="mobile-timeline-card-2070">
